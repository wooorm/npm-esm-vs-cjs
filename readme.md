...
> 👉 **Note**:
> the crawl of `2025-12-04` moves to `ecosyste.ms` from `libraries.io` and npm
> itself,
> that gives a larger list of popular packages,
> particularly more packages that are depended on a lot.
